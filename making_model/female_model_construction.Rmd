...
#### AT THIS POINT THE ADJUSTED R^2 GOES DOWN!!!!
...
Iteration 15:
```{r correlations-iteration-15, include=FALSE}
#find most highly correlated column
corrs <- findMaxCorr(df_all, df_model, iternum)
printNBestCorrelations(corrs, 5)
```

```{r make-model-15, include=FALSE}
#swich highly correlated column to model dataframe
switchColumnToModel(df_all, df_model, "sp003_2_mod")
