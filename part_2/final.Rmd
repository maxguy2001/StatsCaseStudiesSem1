...
```{r proprtion_barplots}
#TODO: new variable - needed? Also axis labels + title
...
plot(density(df_final$cogscore) +
       density(df_final$age))
...
lwr1 <- mean - sd * qnorm(0.9) #TODO: naming?
upr2 <- mean - sd * qnorm(0.1)
