...
This shows it for father_alive, by the proportion of if the observations age is greater than 60, then there is only a small porportin with their father still alive.
