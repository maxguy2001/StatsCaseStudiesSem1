...
lm1 <- lm(cogscore ~ female + age + isced1997_r + eduyears_mod + hhsize + 
    sphus + euro5 + eurod + hc002_mod + hc012_ + hc029_ + adla + 
    iadlza + mobilityind + lgmuscle + grossmotor + finemotor + 
    bmi + smoking + ever_smoked + br010_mod + br015_ + diabetes + 
    hypertension, data = df_train)    
